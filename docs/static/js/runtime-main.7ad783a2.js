!(function (e) {
	function t(t) {
		for (
			var n, a, i = t[0], l = t[1], f = t[2], p = 0, s = [];
			p < i.length;
			p++
		)
			(a = i[p]),
	...
	(a.m = e),
		...
		(a.p = './');
	var i = (this['webpackJsonpreact-starter-kit'] =
			this['webpackJsonpreact-starter-kit'] || []),
		l = i.push.bind(i);
	(i.push = t), (i = i.slice());
...
//# sourceMappingURL=runtime-main.7ad783a2.js.map
